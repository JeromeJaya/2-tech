...
export const BookingPreview = ({ selectedAddOns, balloonColors, decoration, ageNumber }: BookingPreviewProps) => {
  const getPreviewIcon = (name: string) => {
  ...
  const getPreviewImage = (name: string, customText?: string) => {
