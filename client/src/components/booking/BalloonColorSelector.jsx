...
export const BalloonColorSelector = ({ 
  ...
  const fetchBalloonColors = async () => {
    try {
      const response = await api.get('/balloon-colors');
      ...
      if (response.data && response.data.success) {
        ...
        const processedData = data.map((color) => ({
          ...color,
          color_type: color.color_type || 'standard',
          available_plans: color.available_plans || ['basic', 'elite', 'premium']
        }));
        setColors(processedData);
      } else {
        throw new Error('Failed to fetch balloon colors');
      }
    } catch (error) {
      console.error('Error fetching balloon colors:', error);
      // Fallback colors if database fetch fails
      const standardColors = [
        { id: '1', name: 'Red', hex_code: '#FF0000', is_suggested: true, sort_order: 1, color_type: 'standard', available_plans: ['basic', 'elite', 'premium'] },
        { id: '2', name: 'Blue', hex_code: '#0000FF', is_suggested: true, sort_order: 2, color_type: 'standard', available_plans: ['basic', 'elite', 'premium'] },
        { id: '3', name: 'Dark Blue', hex_code: '#000080', is_suggested: true, sort_order: 3, color_type: 'standard', available_plans: ['basic', 'elite', 'premium'] },
        { id: '4', name: 'Peach', hex_code: '#FFCBA4', is_suggested: true, sort_order: 4, color_type: 'standard', available_plans: ['basic', 'elite', 'premium'] },
        { id: '5', name: 'Yellow', hex_code: '#FFFF00', is_suggested: true, sort_order: 5, color_type: 'standard', available_plans: ['basic', 'elite', 'premium'] },
        { id: '6', name: 'Light Yellow', hex_code: '#FFFFE0', is_suggested: true, sort_order: 6, color_type: 'standard', available_plans: ['basic', 'elite', 'premium'] },
        { id: '7', name: 'Black', hex_code: '#000000', is_suggested: true, sort_order: 7, color_type: 'standard', available_plans: ['basic', 'elite', 'premium'] },
        { id: '8', name: 'Light Green', hex_code: '#90EE90', is_suggested: true, sort_order: 8, color_type: 'standard', available_plans: ['basic', 'elite', 'premium'] },
        { id: '9', name: 'Dark Green', hex_code: '#006400', is_suggested: true, sort_order: 9, color_type: 'standard', available_plans: ['basic', 'elite', 'premium'] },
        { id: '10', name: 'Sandal', hex_code: '#F4A460', is_suggested: true, sort_order: 10, color_type: 'standard', available_plans: ['basic', 'elite', 'premium'] },
        { id: '11', name: 'White', hex_code: '#FFFFFF', is_suggested: true, sort_order: 11, color_type: 'standard', available_plans: ['basic', 'elite', 'premium'] },
        { id: '12', name: 'Metallic White', hex_code: '#F8F8FF', is_suggested: true, sort_order: 12, color_type: 'standard', available_plans: ['basic', 'elite', 'premium'] },
        { id: '13', name: 'Lavender', hex_code: '#E6E6FA', is_suggested: true, sort_order: 13, color_type: 'standard', available_plans: ['basic', 'elite', 'premium'] },
        { id: '14', name: 'Purple', hex_code: '#800080', is_suggested: true, sort_order: 14, color_type: 'standard', available_plans: ['basic', 'elite', 'premium'] },
        { id: '15', name: 'Dark Purple', hex_code: '#4B0082', is_suggested: true, sort_order: 15, color_type: 'standard', available_plans: ['basic', 'elite', 'premium'] },
        { id: '16', name: 'Metallic Gold', hex_code: '#D4AF37', is_suggested: true, sort_order: 16, color_type: 'standard', available_plans: ['basic', 'elite', 'premium'] },
        { id: '17', name: 'Ash', hex_code: '#B2BEB5', is_suggested: true, sort_order: 17, color_type: 'standard', available_plans: ['basic', 'elite', 'premium'] },
        { id: '18', name: 'Light Pink', hex_code: '#FFB6C1', is_suggested: true, sort_order: 18, color_type: 'standard', available_plans: ['basic', 'elite', 'premium'] },
        { id: '19', name: 'Dark Pink', hex_code: '#C71585', is_suggested: true, sort_order: 19, color_type: 'standard', available_plans: ['basic', 'elite', 'premium'] },
        { id: '20', name: 'Brown', hex_code: '#A52A2A', is_suggested: true, sort_order: 20, color_type: 'standard', available_plans: ['basic', 'elite', 'premium'] },
        { id: '21', name: 'Light Brown', hex_code: '#D2B48C', is_suggested: true, sort_order: 21, color_type: 'standard', available_plans: ['basic', 'elite', 'premium'] },
        { id: '22', name: 'Orange', hex_code: '#FFA500', is_suggested: true, sort_order: 22, color_type: 'standard', available_plans: ['basic', 'elite', 'premium'] },
        { id: '23', name: 'Gray', hex_code: '#808080', is_suggested: true, sort_order: 23, color_type: 'standard', available_plans: ['basic', 'elite', 'premium'] }
      ];
      
      const chromeColors = [
        { id: 'c1', name: 'Chrome Blue', hex_code: '#4169E1', is_suggested: true, sort_order: 24, color_type: 'chrome', available_plans: ['elite', 'premium'] },
        { id: 'c2', name: 'Chrome Green', hex_code: '#32CD32', is_suggested: true, sort_order: 25, color_type: 'chrome', available_plans: ['elite', 'premium'] },
        { id: 'c3', name: 'Chrome Silver', hex_code: '#C0C0C0', is_suggested: true, sort_order: 26, color_type: 'chrome', available_plans: ['elite', 'premium'] },
        { id: 'c4', name: 'Chrome Rose Gold', hex_code: '#E8B4A0', is_suggested: true, sort_order: 27, color_type: 'chrome', available_plans: ['elite', 'premium'] },
        { id: 'c5', name: 'Chrome Purple', hex_code: '#9370DB', is_suggested: true, sort_order: 28, color_type: 'chrome', available_plans: ['elite', 'premium'] }
      ];
