...
import { useAuth } from "../../contexts/AuthContext" // Import the useAuth hook (removed .jsx)
...
export function AdminSidebar({ children }) {
  ...
  const handleLogout = () => {
    ...
    logout()
    // localStorage.removeItem("adminUser") // This is now handled by AuthContext
    navigate("/admin/login") // Navigate to login after state is cleared
  }
