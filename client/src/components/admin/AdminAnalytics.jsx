...
// Removed direct axios import, we'll use our booking service
import { BarChart3, TrendingUp, Calendar, Users, DollarSign, Clock, CheckCircle, AlertCircle } from "lucide-react"
// Import the booking service which uses our central 'api.js'
...
export function AdminAnalytics() {
  ...
  const fetchAnalytics = async () => {
    try {
      // Replace Supabase call with our service function
      ...
      // The rest of your analytics logic remains the same, as it's
      // just processing the array of bookings.
